...
const prefetchMap: Record<string, () => Promise<unknown>> = {
  ...
  '/studio':     () => import('@/pages/ReelStudioPage'),
  '/story-arcs': () => import('@/pages/StoryArcsPage'),
    ...
    <div className="flex h-screen overflow-hidden bg-[var(--bg-primary)]">
      ...
      >
        ...
        <nav className="sm-nav-scroll flex flex-1 flex-col gap-1.5 overflow-y-auto px-2 py-3">
          ...
          <SectionGroup icon={Clapperboard} iconColor="text-violet-400" label="Content" collapsed={collapsed}>
            <NavItem to="/studio"     icon={Video}     label="Reel Studio" collapsed={collapsed} />
            <NavItem to="/reels"      icon={Film}      label="Reels"       collapsed={collapsed} />
            <NavItem to="/story-arcs" icon={Layers}    label="Story Arcs"  collapsed={collapsed} />
            <NavItem to="/recipes"    icon={BookOpen}  label="Recipes"     collapsed={collapsed} />
          </SectionGroup>

          <SectionGroup icon={Rocket} iconColor="text-pink-400" label="Growth" collapsed={collapsed}>
            <NavItem to="/partnerships" icon={Handshake} label="Partnerships" collapsed={collapsed} />
            <NavItem to="/reach"        icon={Radio}     label="Reach"        collapsed={collapsed} />
          </SectionGroup>

          <SectionGroup icon={CircleDollarSign} iconColor="text-emerald-400" label="Finance" collapsed={collapsed}>
...
export function AppShellSkeleton() {
  return (
    <div className="flex h-screen animate-pulse">
      <div className="w-60 shrink-0 bg-[var(--bg-secondary)]" />
