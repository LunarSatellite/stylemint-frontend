...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen bg-bg-primary">
      ...
      {/* ── Left column — animated overview widget ── */}
      <div
      ...
      >
        ...
        {/* Phase toggle — absolute bottom-centre */}
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-10 flex" style={{ background: '#0F1E1A', border: '1px solid rgba(0,217,138,0.15)', borderRadius: 999, padding: 4, gap: 4, alignItems: 'center' }}>
          <button id="toggle-studio" style={{ display: 'flex', alignItems: 'center', gap: 7, padding: '6px 16px', borderRadius: 999, border: 'none', cursor: 'pointer', fontSize: 11, fontWeight: 700, background: 'rgba(0,217,138,0.15)', color: '#00D98A', transition: 'all 0.3s ease', overflow: 'hidden' }}>
            ...
            <span id="toggle-studio-label" style={{ transition: 'all 0.3s ease', whiteSpace: 'nowrap', overflow: 'hidden' }}>Creator Studio</span>
          </button>
          <button id="toggle-mobile" style={{ display: 'flex', alignItems: 'center', gap: 0, padding: '6px 6px', borderRadius: 999, border: 'none', cursor: 'pointer', fontSize: 11, fontWeight: 700, background: 'transparent', color: '#7A9B8E', transition: 'all 0.3s ease', overflow: 'hidden' }}>
            ...
            <span id="toggle-mobile-label" style={{ maxWidth: 0, opacity: 0, overflow: 'hidden', whiteSpace: 'nowrap', transition: 'all 0.3s ease' }}>Mobile View</span>
          </button>
        </div>
      </div>

      {/* ── Right column — QR login panel ── */}
              ...
              <div className="flex items-center justify-between px-[22px] pt-[22px] pb-[18px] relative z-[1]">
                <div className="flex items-center gap-[9px]">
                  <div
                    ...
                    style={{ background: 'linear-gradient(135deg,#00D98A,#00B872)', boxShadow: '0 0 16px rgba(0,217,138,0.55), 0 4px 8px rgba(0,0,0,0.3)' }}
                  >C</div>
                  <div>
                    <div
                      className="text-[13px] font-extrabold tracking-[.3px] inline-block"
                      style={{ background: 'linear-gradient(135deg, #ffffff 0%, #00D98A 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}
                    >StyleMint</div>
                    <div className="text-[9px] font-semibold text-[#7A9B8E] tracking-[.5px] uppercase mt-px">Creator Studio</div>
                  </div>
                </div>
              ...
              <div className="px-[22px] pt-[22px] pb-[18px] relative z-[1]">
                ...
                >
                  ...
                  <div
                    ...
                    style={{ backgroundImage: 'radial-gradient(circle, rgba(0,217,138,0.1) 1px, transparent 1px)', backgroundSize: '9px 9px' }}
                  >
                    {/* scan line */}
                    <div
              ...
              <div className="px-[22px] pb-[22px] mt-4 relative z-[1]">
                ...
                <div className="flex items-center gap-2 mb-3.5 px-3.5 py-2.5 bg-[rgba(0,217,138,0.04)] border border-[rgba(0,217,138,0.1)] rounded-[10px]">
                  ...
                  <p className="text-[11px] text-[#7A9B8E] leading-[1.4] m-0">
                    Scan the QR Code to sign in.<br />
                    <span className="text-[#B8E6D5] font-semibold">Access your Creator Studio dashboard.</span>
                  </p>
                </div>
                ...
                >
                  ...
                  <span className="text-[18px] font-extrabold text-[#030d08] tracking-[.3px] relative z-[1]">Go To Creator Studio</span>
